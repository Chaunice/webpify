    ...
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        ...
        egui::TopBottomPanel::top("top_panel").show(ctx, |ui| {
            ui.vertical(|ui| {
                ...
                ui.horizontal(|ui| {
                    ...
                    // Step 4: Convert
                    let step4_color =
                        if matches!(self.current_tab, Tab::Progress) || self.is_converting {
                            egui::Color32::BLUE
                        } else {
                            egui::Color32::GRAY
                        };
                    ...
                    // Step 5: Results
                    let step5_color =
                        if matches!(self.current_tab, Tab::Results) || self.last_report.is_some() {
                            egui::Color32::BLUE
                        } else {
                            egui::Color32::GRAY
                        };
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .selectable_value(
                        ...
                        Tab::Input,
                        &Icons::with_text(Icons::FOLDER, "Input & Output"),
                    )
                    .clicked()
                {
                ...
                ui.selectable_value(
                    &mut self.current_tab,
                    Tab::Settings,
                    &Icons::with_text(Icons::SETTINGS, "Settings"),
                );
                ui.selectable_value(
                    &mut self.current_tab,
                    Tab::Advanced,
                    &Icons::with_text(Icons::ADVANCED, "Advanced"),
                );
                ...
                if self.is_converting || self.total_files > 0 {
                    ui.selectable_value(
                        &mut self.current_tab,
                        Tab::Progress,
                        &Icons::with_text(Icons::PROGRESS, "Progress"),
                    );
                }
                if self.last_report.is_some() || self.error_message.is_some() {
                    ui.selectable_value(
                        &mut self.current_tab,
                        Tab::Results,
                        &Icons::with_text(Icons::RESULTS, "Results"),
                    );
                }
        ...
        egui::TopBottomPanel::bottom("bottom_panel").show(ctx, |ui| {
            ...
            ui.horizontal(|ui| {
                ...
                let stop_btn = self
                    .secondary_button(ui, &Icons::with_text(Icons::STOP, "Stop"))
                ...
                let clear_btn = self
                    .secondary_button(ui, &Icons::with_text(Icons::CLEAR, "Clear"))
                ...
                ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                    if !can_convert && !self.input_dir.is_empty() {
                        ...
                        UiHelpers::status_indicator(
                            ui,
                            Icons::INFO,
                            "Select an input directory to begin",
                            StatusType::Info,
                        );
                    } else if can_convert {
                        // Show estimated info
...
impl WebpifyGuiApp {
            ...
            ui.vertical(|ui| {
                ...
                ui.group(|ui| {
                    ...
                    ui.vertical(|ui| {
                        ui.horizontal(|ui| {
                            ui.label(
                                egui::RichText::new("📁 Input Directory")
                                    .size(16.0)
                                    .strong(),
                            );
                            if !self.input_dir.is_empty() {
                        ...
                        if !self.input_dir.is_empty() {
                            ...
                            if path.exists() {
                                ui.label(
                                    egui::RichText::new("✅ Directory exists and is accessible")
                            ...
                            ui.label(
                                egui::RichText::new(
                                    "ℹ️ Choose a folder containing images to convert",
                                )
                ...
                ui.group(|ui| {
                    ui.vertical(|ui| {
                        ui.label(
                            egui::RichText::new("🎯 File Format Filter")
                                .size(16.0)
                                .strong(),
                        );
                        ui.add_space(10.0);
                        ...
                        ui.add(
                            egui::TextEdit::multiline(&mut self.formats)
                                .desired_rows(2)
                ...
                ui.group(|ui| {
                    ui.vertical(|ui| {
                        ...
                        ui.horizontal(|ui| {
                            ...
                            if ui
                                .add_enabled(!self.output_dir_auto, egui::Button::new("📂 Browse"))
                                .clicked()
                            {
                                if let Some(path) = rfd::FileDialog::new()
                        ...
                        if !self.output_dir.is_empty() {
                            ui.label(
                                egui::RichText::new(format!("📁 Output: {}", self.output_dir))
        ...
        ui.horizontal(|ui| {
            ...
            ui.vertical(|ui| {
                ...
                ui.group(|ui| {
                    ui.vertical(|ui| {
                        ui.label(
                            egui::RichText::new("🎯 Quality Presets")
                                .size(16.0)
                                .strong(),
                        );
                        ui.add_space(10.0);
                        ...
                        ui.horizontal(|ui| {
                            if ui
                                .selectable_label(self.quality == 95, "🏆 Best")
                                .on_hover_text("95% quality, perfect for archival")
                                .clicked()
                            {
                                self.quality = 95;
                            ...
                            if ui
                                .selectable_label(self.quality == 85, "⚖️ Balanced")
                                .on_hover_text("85% quality, good compromise")
                                .clicked()
                            {
                                self.quality = 85;
                            ...
                            if ui
                                .selectable_label(self.quality == 70, "📦 Small")
                                .on_hover_text("70% quality, smaller files")
                                .clicked()
                            {
                                self.quality = 70;
                            ...
                            if ui
                                .selectable_label(self.quality == 50, "🗜️ Tiny")
                                .on_hover_text("50% quality, very small files")
                                .clicked()
                            {
                                self.quality = 50;
                                self.mode = CompressionMode::Lossy;
                ...
                ui.group(|ui| {
                    ui.vertical(|ui| {
                        ui.label(
                            egui::RichText::new("📁 File Processing")
                                .size(16.0)
                                .strong(),
                        );
                        ui.add_space(10.0);
                        ...
                        ui.checkbox(
                            ...
                            "🗂️ Preserve directory structure",
                        );
                        ...
                        ui.horizontal(|ui| {
                            ...
                            if ui
                                .add(egui::DragValue::new(&mut self.min_size).range(1..=10000))
                                .changed()
                            {
                        ...
                        ui.horizontal(|ui| {
                            ...
                            let _text_edit = ui.add(
                                egui::TextEdit::singleline(&mut self.max_size)
                                    .desired_width(80.0)
                                    .hint_text("No limit"),
                            );
            ...
            ui.vertical(|ui| {
                ...
                ui.group(|ui| {
                    ui.vertical(|ui| {
                        ...
                        ui.horizontal(|ui| {
                            ui.add_enabled(
                                !self.threads_auto,
                                egui::Label::new("🧵 Thread Count:"),
                            );
                            let _thread_edit = ui.add_enabled(
                                !self.threads_auto,
                                egui::TextEdit::singleline(&mut self.threads).desired_width(60.0),
                            );
                        ...
                        ui.collapsing("💡 Performance Tips", |ui| {
                            ui.label(
                                egui::RichText::new("• More threads = faster conversion")
                                    .size(11.0)
                                    .color(egui::Color32::GRAY),
                            );
                            ui.label(
                ...
                ui.group(|ui| {
                    ui.vertical(|ui| {
                        ui.label(
                            egui::RichText::new("✅ Settings Summary")
                                .size(16.0)
                                .strong(),
                        );
                        ui.add_space(10.0);
    ...
    fn show_advanced_tab(&mut self, ui: &mut egui::Ui) {
        ...
        ui.group(|ui| {
            ...
            if self.replace_input != ReplaceInputMode::Off {
                ui.colored_label(
                    egui::Color32::ORANGE,
                    "⚠️ Warning: This will modify/remove your original files!",
                );
            }
        });
        ...
        ui.group(|ui| {
            ...
            ui.checkbox(
                &mut self.dry_run,
                "Dry run mode (preview only, no actual conversion)",
            );
        ...
        ui.group(|ui| {
            ...
            if self.verbose && self.quiet {
                ui.colored_label(
                    egui::Color32::ORANGE,
                    "⚠️ Verbose and Quiet modes conflict - Verbose will take priority",
                );
                self.quiet = false;
            }
        });
            ...
            ui.group(|ui| {
                ...
                ui.horizontal(|ui| {
                    ...
                    if self.failed_files > 0 {
                        ui.colored_label(
                            egui::Color32::RED,
                            format!("❌ Failed: {}", self.failed_files),
                        );
                    }
                    let remaining = self
                        .total_files
                        .saturating_sub(self.processed_files + self.failed_files);
                    if remaining > 0 {
                ...
                egui::Grid::new("file_stats")
                    ...
                    .show(ui, |ui| {
                        ...
                        if report.failed_files > 0 {
                            ...
                            ui.colored_label(
                                egui::Color32::RED,
                                format!("{} files", report.failed_files),
                            );
                            ui.end_row();
                        }
            ...
            Ok(_) => {
                ...
                if self.preview_files.is_empty() {
                    self.error_message = Some(format!(
                        "No files with supported formats ({}) found in directory",
                        self.formats
                    ));
                }
            }
    ...
    fn show_input_help(&self, ui: &mut egui::Ui) {
        ui.group(|ui| {
            ui.label(
                egui::RichText::new("📁 Input & Output Help")
                    .size(16.0)
                    .strong(),
            );
            ui.add_space(5.0);
                        ...
                        if let Err(e) = webpify::generate_report(&report, &report_format) {
                            if let Ok(mut progress) = progress_reporter.lock() {
                                progress.error = Some(format!(
                                    "Conversion succeeded but failed to generate report: {}",
                                    e
                                ));
